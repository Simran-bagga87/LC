...
if name_of_act=="Shops and Establishments Act 2017":
    ...
    st.write("name of act",name_of_act)
    st.write("state",state)
    st.write("name_of_establishment",name_of_establishment)
    st.write("establishment_type",establishment_type)
    st.write("category_of_employer",category_of_employer)
    st.write("business_or_trade_type",business_or_trade_type)
    st.write("manager",manager)
    st.write("date_of_opening",date_of_opening)
    slot1,slot2,slot3,slot4,slot5 = slots
    st.write("slots",slot1,slot2,slot3,slot4,slot5)
...
# ----------------------------
    def insert_into_db(data, state):
        ...
        cursor.execute(sql, transform(data))
        conn.commit()
        conn.close()
